...
export const travelGallery: TravelEntry[] = [
  { title: "舷窗之外", location: "海上航行", year: "年份待补充" },
  { title: "飞往上海的云", location: "上海上空", year: "年份待补充" },
  { title: "飞往东京的云 · I", location: "东京上空", year: "年份待补充" },
  { title: "飞往东京的云 · II", location: "东京上空", year: "年份待补充" },
  { title: "雪山与云", location: "新疆", year: "年份待补充" },
  { title: "玉龙雪山窗景", location: "云南 · 丽江", year: "年份待补充" },
  { title: "丽江 · II", location: "云南 · 丽江", year: "年份待补充" },
  { title: "丽江 · III", location: "云南 · 丽江", year: "年份待补充" },
  { title: "大理窗景", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · II", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · III", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · IV", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · V", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · VI", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · VII", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · VIII", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · IX", location: "云南 · 大理", year: "年份待补充" },
  { title: "大理 · X", location: "云南 · 大理", year: "年份待补充" },
  { title: "古城窗外", location: "山西 · 大同", year: "年份待补充" },
  { title: "湿地的天空", location: "黑龙江 · 杜尔伯特", year: "年份待补充" },
  { title: "海与口琴", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · II", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · III", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · IV", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · V", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · VI", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · VII", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "枸杞岛 · VIII", location: "浙江 · 枸杞岛", year: "年份待补充" },
  { title: "日本旅途 · I", location: "日本", year: "年份待补充" },
  { title: "日本旅途 · II", location: "日本", year: "年份待补充" },
  { title: "江之岛鱼见亭", location: "日本 · 江之岛", year: "年份待补充" },
  { title: "东京台场", location: "日本 · 东京", year: "年份待补充" },
  { title: "清水寺的红灯笼", location: "日本 · 京都", year: "年份待补充" },
  { title: "大阪 USJ", location: "日本 · 大阪", year: "年份待补充" },
  { title: "日本旅途 · VII", location: "日本", year: "年份待补充" },
  { title: "日本旅途 · VIII", location: "日本", year: "年份待补充" },
  { title: "雨夜车窗", location: "上海", year: "年份待补充" },
  { title: "雪中的小熊猫 · I", location: "地点待补充", year: "年份待补充" },
  { title: "雪中的小熊猫 · II", location: "地点待补充", year: "年份待补充" },
];
